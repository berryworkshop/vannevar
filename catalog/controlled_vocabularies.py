'''
Controlled Vocabularies are choice sets for models, either:
    * shared by multiple models
    * standardized by an external entity
    * determined synchronously at runtime
'''
...
# world countries standard 3-letter codes
